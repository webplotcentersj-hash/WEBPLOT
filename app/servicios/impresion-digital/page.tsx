...
/** Galería — fotos de plotcenter.com.ar/impresion-digital-2 */
const GALLERY_IMAGES = [
  "https://plotcenter.com.ar/wp-content/uploads/2025/05/Rectangle-72.png",
  "https://plotcenter.com.ar/wp-content/uploads/2025/05/Rectangle-69-2.png",
  "https://plotcenter.com.ar/wp-content/uploads/2025/05/Rectangle-85.png",
]
...
const SERVICES_CONTENT = {
  formatos: {
    title: "FORMATOS",
    description:
      "Trabajamos con una amplia gama de formatos: A3, A4 y A5, opciones especiales y personalizadas. Desde tarjetas, etiquetas y flyers hasta afiches, carteles, banners, ploteos y planos.",
    accent: brand.cyan,
  },
  materiales: {
    title: "MATERIALES",
    description:
      "Materiales de calidad certificada: lona front, backlight, black out y mesh; vinilo brillante, transparente, microperforado, de alto tránsito, de corte, reflectivo, esmerilado e imantado; papel blueback, obra, ilustración, adhesivo y químico; e imán.",
    accent: brand.orange,
  },
  soportes: {
    title: "SOPORTES RÍGIDOS",
    description:
      "PVC espumado, PVC de alto impacto, MDF, plástico corrugado, chapa y acrílico. Ideales para señalética interior y exterior, placas institucionales, señalización vial y carteles industriales.",
    accent: brand.pink,
  },
}

const FEATURES = [
  "Formatos estándar y personalizados (A3, A4, A5 y especiales)",
  "Piezas pequeñas: tarjetas, etiquetas y flyers",
  "Gran formato: afiches, carteles, banners, ploteos y planos",
  "Lonas: front, backlight, black out y mesh",
  "Vinilos: brillante, transparente, microperforado, reflectivo y más",
  "Papeles: blueback, obra, ilustración, adhesivo y químico",
  "Soportes rígidos: PVC, MDF, corrugado, chapa y acrílico",
]
...
export default function ImpresionDigitalPage() {
  const [activeTab, setActiveTab] = useState<keyof typeof SERVICES_CONTENT>("formatos")
  ...
  return (
    <main className="min-h-screen text-plot-ink relative overflow-x-clip bg-plot-bg">
      ...
      <>
          ...
          >
            ...
            >
              ...
              <p className="text-lg md:text-xl text-plot-ink/70 font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
                Formatos, materiales y soportes para cada proyecto. De tarjetas y flyers a
                gran formato, ploteos y señalética con calidad certificada.
              </p>
        ...
        {/* Qué imprimimos + tabs — columnas de igual altura */}
          ...
          <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch">
            ...
            >
              ...
              <h2 className="relative text-3xl md:text-4xl font-display uppercase tracking-tight text-plot-ink mb-4">
                Qué <span className="text-brand-cyan">imprimimos</span>
              </h2>
              <p className="relative text-plot-ink/65 font-medium mb-6 leading-relaxed">
                Soluciones gráficas con diseño e impresión de alto impacto:
              </p>
                  ...
                  (tab, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isActive && (
                          <motion.span
                            layoutId="impresion-digital-active-bar"
        ...
        <section className="py-20 md:py-28 relative z-10 overflow-hidden border-y border-brand-navy/10 bg-brand-navy">
          ...
          <div className="relative max-w-[1280px] mx-auto text-center mb-16 md:mb-24 px-6">
            ...
            <p className="text-white/65 max-w-2xl mx-auto text-lg font-medium">
              Formatos, materiales y soportes de nuestra imprenta digital.
            </p>
          </div>
        ...
        <section className="relative z-10 py-20 px-6">
          <div className="max-w-3xl mx-auto text-center rounded-[1.5rem] sm:rounded-[2rem] bg-white/95 border border-brand-navy/10 p-6 sm:p-8 md:p-14 shadow-[0_20px_50px_-20px_rgba(26,30,56,0.2)]">
            <h2 className="text-3xl md:text-5xl font-display uppercase tracking-tight text-plot-ink mb-4">
              Tu proyecto en <span className="text-brand-orange">impresión</span>
            </h2>
            <p className="text-plot-ink/65 text-lg mb-8 font-medium">
              Contanos el formato y el material: lo imprimimos con calidad Plot.
            </p>
            <a
              href={WHATSAPP_URL}
              target="_blank"
